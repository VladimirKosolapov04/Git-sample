...
public class hangar {
	...
	public void Read_hangar(int i) {
		...
		try {
			if (n < 0)
				throw new Exception ("Количество не может быть < 0. Кол-во машин будет умножено на -1.\n");
			if (n == 0)
				throw new Exception ("Количество не может быть = 0. Кол-во машин будет приравнено 1.\n");
			}
			catch (Exception e){
