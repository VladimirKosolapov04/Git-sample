...
namespace Modification_C_sharp
{
	public class Auto
	{
		String car_brand;
			...
			do
			{
				...
				switch (i)
				{
					...
					case 2:
						...
						Console.Write("|                |                 |               |        |        |\n");
						Console.Write("|   Тип кузова   |    Марка авто   |  Год выпуска  | Кол-во |  Цена  |\n");
						Console.Write("|________________|_________________|_______________|________|________|\n");
						for (int j = 0; j < k; j++)
						{
